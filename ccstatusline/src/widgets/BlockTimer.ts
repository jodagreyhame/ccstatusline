...
export class BlockTimerWidget implements Widget {
    ...
    render(item: WidgetItem, context: RenderContext, settings: Settings): string | null {
        ...
        if (context.isPreview) {
            ...
            return item.rawValue ? '3h45m' : 'Block: 3h45m';
        }
        ...
        if (!blockMetrics) {
            ...
            if (displayMode === 'progress' || displayMode === 'progress-short') {
                ...
                return item.rawValue ? '0m' : 'Block: 0m';
            }
        }
        ...
        try {
            ...
            if (displayMode === 'progress' || displayMode === 'progress-short') {
                ...
                if (elapsedHours === 0 && elapsedMinutes === 0) {
                    ...
                    timeString = `${elapsedMinutes}m`;
                } else if (elapsedMinutes === 0) {
                    timeString = `${elapsedHours}h`;
                } else {
                    timeString = `${elapsedHours}h${elapsedMinutes}m`;
                }
